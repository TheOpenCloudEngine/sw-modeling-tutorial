...
public class AutoinsurancePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Autoinsurance";
	...
	private AutoinsurancePersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new AutoinsurancePersistentManager();
		}
